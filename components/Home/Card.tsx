    ...
    <div className="content-cards">
      <div className="card">
        <div className="card-header white">
          ...
          <Image src={item.img_url} alt={item.name} width={100} height={100} />
        </div>
        <div className="card-content">
          <div className="card-content-type">
            ...
            {item.types.map((type, index) => (
              <div
                key={index}
                className="pkmn-type"
                style={{ backgroundColor: getColour(type as ColourType) }}
              >
                {type}
              </div>
            ))}
          ...
          <div className="card-content-stats">
            ...
            <p>
              ...
              <span
                className="stat-line"
                style={{ width: `${(item.stats.hp / 255) * 100}%` }}
              ></span>
            </p>
            <p>
              ...
              <span
                className="stat-line"
                style={{ width: `${(item.stats.attack / 190) * 100}%` }}
              ></span>
            </p>
            <p>
              ...
              <span
                className="stat-line"
                style={{ width: `${(item.stats.defense / 250) * 100}%` }}
              ></span>
            </p>
            <p>
              <b>Special Attack:</b> {item.stats["special-attack"]}
              <span
                className="stat-line"
                style={{
                  width: `${(item.stats["special-attack"] / 194) * 100}%`,
                }}
              ></span>
            </p>
            <p>
              <b>Special Defense:</b> {item.stats["special-defense"]}
              <span
                className="stat-line"
                style={{
                  width: `${(item.stats["special-defense"] / 250) * 100}%`,
                }}
              ></span>
            </p>
            <p>
              ...
              <span
                className="stat-line"
                style={{ width: `${(item.stats.speed / 200) * 100}%` }}
              ></span>
            </p>
          </div>
        </div>
