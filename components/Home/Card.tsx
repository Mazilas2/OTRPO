          ...
          <div className="card-content-type">
            ...
            {item.types.map((type, index) => (
              <div
                ...
                className="pkmn-type"
                style={{
                  backgroundColor: getColour(type as ColourType),
                }}
              >
                {type}
              </div>
          ...
          <div className="card-content-stats">
            ...
            <p>
              ...
              <span
                className="stat-line"
                style={{
                  width: `${(item.stats.attack / 190) * 100}%`,
                }}
              ></span>
            </p>
            <p>
              ...
              <span
                className="stat-line"
                style={{
                  width: `${(item.stats.defense / 250) * 100}%`,
                }}
              ></span>
            </p>
            <p>
              ...
              {Array.from({ length: 5 }).map((_, index) => (
                <input
                  ...
                  className={`mask mask-star-2 ${
                    index < averageRating ? "bg-orange-400" : "bg-gray-300"
                  }`}
